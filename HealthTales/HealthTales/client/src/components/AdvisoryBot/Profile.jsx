...
function Profile() {
  ...
  const advisoryMagic = "I want you to act as a life coach. I will provide some details about my current situation and goals, the details are below: " + /^\n\n/;
  ...
  let messag = [{ sender: "user", message: "Hi, I am Javeed, My height is 5.6 and weight is 65kg" }];
  ...
  const fetchSummarized = () => {
    ...
    fetch(url, {
      ...
      .then(data => { messag[0].message = data })
      .catch((e) => {
        messag[0].message = "Hi, I am Javeed."
      })
  ...
  return (
    <div className='bg-[#1A232E] h-screen py-6 relative sm:px-16 px-12 text-white overflow-hidden flex flex-col justify-between align-middle'>
      ...
      <TitleText
        title={<>Advisory Mentor <br className="md:block hidden" /></>}
